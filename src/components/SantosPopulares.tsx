...
const CONFIRMED_FESTIVALS: Festival[] = [
  ...
  {
    id: 'arroios',
    name: 'Arraial de Arroios',
    neighborhood: 'Arroios',
    location: 'Arroios — Rua de Arroios, Clube Atlético de Arroios',
    dates: 'Unconfirmed dates',
    startDay: 99,
    description: 'Growing neighborhood arraial with live music. Also hosts Santo António dos Pequeninos for kids.',
  },
  {
    id: 'carnide',
    name: 'Arraial de Carnide',
    neighborhood: 'Carnide',
    location: 'Carnide — Rua Neves Costa',
    dates: 'Unconfirmed dates',
    startDay: 99,
    description: 'One of the longest-running arraiais, deep in the village-like neighborhood of Carnide.',
  },
  {
    id: 'belem',
    name: 'Grande Arraial de Belém',
    neighborhood: 'Belém',
    location: 'Belém — Parque dos Moinhos de Santana',
    dates: 'Unconfirmed dates',
    startDay: 99,
    description: 'Large-scale arraial near the waterfront, family-friendly with plenty of space.',
  },
  {
    id: 'campolide',
    name: 'Santos à Campolide',
    neighborhood: 'Campolide',
    location: 'Campolide — Rua de Campolide, Quinta do Zé Pinto',
    dates: 'Unconfirmed dates',
    startDay: 99,
    description: 'Neighborhood celebration in the heart of Campolide with traditional food and music.',
  },
  {
    id: 'santos',
    name: 'Santos em Santos',
    neighborhood: 'Santos',
    location: 'Santos — Terrapleno de Santos',
    dates: 'Unconfirmed dates',
    startDay: 99,
    description: 'Riverside arraial in the Santos neighborhood, popular with locals and visitors alike.',
  },
  {
    id: 'avenidas-novas',
    name: 'Grande Arraial Avenidas Novas',
    neighborhood: 'Avenidas Novas',
    location: 'Avenidas Novas — Praça do Campo Pequeno',
    dates: 'Unconfirmed dates',
    startDay: 99,
    description: 'Large arraial at the iconic Campo Pequeno bullring square.',
  },
  {
    id: 'lumiar',
    name: 'Arraiais no Lumiar',
    neighborhood: 'Lumiar',
    location: 'Lumiar — Paço do Lumiar',
    dates: 'Unconfirmed dates',
    startDay: 99,
    description: 'Village-like celebrations in one of Lisbon\'s most historic parishes.',
  },
  {
    id: 'alvalade',
    name: 'Arraial de Alvalade',
    neighborhood: 'Alvalade',
    location: 'Alvalade — Complexo Desportivo Municipal de São João de Brito',
    dates: 'Unconfirmed dates',
    startDay: 99,
    description: 'Sports complex hosts a family-friendly arraial around São João.',
  },
  {
    id: 'benfica',
    name: 'Grande Arraial de Benfica',
    neighborhood: 'Benfica',
    location: 'Benfica — Alameda Padre Álvaro Proença',
    dates: 'Unconfirmed dates',
    startDay: 99,
    description: 'One of Lisbon\'s biggest arraiais, later in June with major musical acts.',
  },
  {
    id: 'alcantara',
    name: 'Romaria de Santo Amaro',
    neighborhood: 'Alcântara',
    location: 'Alcântara — Academia de Santo Amaro',
    dates: 'Unconfirmed dates',
    startDay: 99,
    description: 'Traditional romaria (pilgrimage festival) in Alcântara, one of the oldest celebrations.',
  },
  {
    id: 'sao-joao',
    name: 'São João',
